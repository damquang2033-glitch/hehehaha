          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {displayedAmenities.map((amenity, idx) => (
              <Badge
                key={idx}
                variant="secondary"
                className="bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 font-normal text-xs"
              >
            ...
            {amenitiesArray.length > 4 && (
              <Badge
                variant="secondary"
                className="bg-slate-100 dark:bg-slate-800 text-slate-500 font-normal text-xs"
              >
                +{amenitiesArray.length - 4}
              </Badge>
            )}
